...
if __name__ == "__main__":
    ...
    path_extracted_corpus = "/data/mszhang/ACL2017-Word2Vec/experiments-final/for-liuzonglin/file0120/extracted_sentence_corpus/SST1/extracted_SST2_statstic.txt"
