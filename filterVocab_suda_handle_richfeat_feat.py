...
def handle_feat_to_small_speed(d=None, vec=None, save_small_feat_path=None):
    if os.path.exists(save_small_feat_path):
        os.remove(save_small_feat_path)
...
if __name__ == "__main__":
    ...
    # print(d)
    handle_feat_to_small_speed(d=d, vec=vec, save_small_feat_path=save_small_feat_path)
