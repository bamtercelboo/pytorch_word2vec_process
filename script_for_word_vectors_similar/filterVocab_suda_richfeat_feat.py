# @Author : bamtercelboo
# @Datetime : 2018/1/23 9:22
# @File : filterVocab_suda_richfeat_feat.py
# @Last Modify Time : 2018/1/23 9:22
...
def handle_feat(data_dict=None, feat_dict=None, corpus_dict=None, path_filtedVectors=None):
...
if __name__ == "__main__":
    ...
    handle_feat(data_dict=data_dict, feat_dict=feat_dict, corpus_dict=corpus_dict, path_filtedVectors=path_filtedVectors)
