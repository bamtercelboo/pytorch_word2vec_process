...
def read_line(line=None, fileter_ratio=1.0):
    line = line.strip().split(" ")
    word_dict ={}
    window_dict = {}
...
def context_n_gram(word=None, corpus_dict=None, feat_embed_dict=None):
    ...
    if word in corpus_dict:
        line = linecache.getline(path_corpus, int(corpus_dict[word]))
        corpus_line_dict = read_line(line)
        count_word = corpus_line_dict[word]["count"]
        # print("count_word", count_word)
        for word_context_feat in corpus_line_dict[word]:
            # print(word_win_feat)
            if word_context_feat in feat_embed_dict:
                count_context = corpus_line_dict[word][word_context_feat]
...
if __name__ == "__main__":
    ...
    path_corpus = "/data/mszhang/ACL2017-Word2Vec/data/save_enwiki_20150112_text_context_ngram_allcorpus/enwiki_20150112_text_context_ngram_allcorpus_sorted/enwiki-20150112_text_context_ngram_allcorpus_stastic/enwiki-20150112_text_context_ngram_allcorpus_stastic_for_richfeatsource_handled.txt"
    ...
    path_result = "./Error_result_richfeat0120.txt"
