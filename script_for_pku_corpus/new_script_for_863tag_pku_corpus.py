...
def read_pku_z_corpus(pku_z_corpus=None):
    ...
    with open(pku_z_corpus, encoding="UTF-8") as f:
        for line in f:
            ...
            z_corpus["flag" + new_line.replace(" ", "")] = line[(line.find("  ") + 2):].strip("\n")
...
if __name__ == "__main__":
    ...
    save_corpus = "./data/pku_tag/pku.split.train.863tag.txt"
    save_untag_corpus = "./data/pku_tag/pku.split.train.863untag.txt"
